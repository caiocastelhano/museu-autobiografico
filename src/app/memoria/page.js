    ...
    <div className={styles.pageContainer}>
      ...
      <main className={styles.mainContent}>
          ...
          <div className={styles.introContent}>
            ...
            <div className={styles.introText}>
              ...
              <p>
                ...
                amígdala, região ligada ao processamento emocional.</i>
              </p>
              <p>
                <i>Nas rodadas da oficina <b>Museu Autobiográfico e Território_Leste,
                ...
                individuais, se tornaram coletivas</b>. Dentro desse sentido, trago nessa
                ...
                e narrativas dos acontecimentos das oficinas.</i>
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
            ...
            <p>
                <i>Das memórias registradas mais bonitas, encontrei recentemente a Lista de Presença das primeiras pessoas 
                participantes de minha oficina.</i>
            </p>
            <p>
                <i>O primeiro encontro aconteceu em 07 de agosto de 2022, dia dos pais. O Centro Cultural da Penha se equivocou e anunciou o 
                início para o dia 14 de agosto, mas, nas mídias estava como dia 07. Com isso, ganhe dois inícios dessa experiência tão significativa.</i>
            </p>
            <div>
                <Image
        ...
        <section>
            <p>
                <b>MEMÓRIA DE 2022 |</b> O exercício de grupo na primeira rodada da <b>Oficina no Centro Cultural da Penha</b> (CCP): <b>Se eu fosse você</b>
            </p>
            <p>
        ...
        <section>
            ...
            <p>
                <b>Para fixar essa memória coletiva, trago agora depoimentos de pessoas participantes da Oficina no Centro Cultural da Penha em 2022.</b>
            </p>
            <p>
                <b>O objetivo destes depoimentos encaminhados por participantes era de manter o trabalho da Oficina no mesmo lugar em 2023.</b>
            </p>
            <h4>
            ...
            <p>
                <i>Fecho os olhos, respiro, relaxo e me permito lembrar, reviver, viver e me expor. Crio novas memórias a partir de tudo que já vivi e choro. Estou viva. Eu me sinto viva. Eu existo. Ali, onde uma pessoa se permite ser diante de tantas diferenças e individualidades, eu também me permito. Ali é mais fácil. Com você é mais fácil. Juntos a possibilidade é uma certeza.</i>
            </p>
            <p>
                <i>As memórias são vivas, presentes e sinceras. Parei de ignorá-las e evitá-las, esse medo se fez pequeno perto da vontade de criar novas memórias e registrar fisicamente e mentalmente aquilo que não volta mais, pelo menos não da mesma forma em que um dia ela existiu.</i>
            </p>
            <p>
                <i>Entre risos e choros, observo admirada e orgulhosa de fazer parte da memória de alguém que jamais sairá da minha. Olho ao meu redor e percebo o quanto foi importante tudo que vivi, com quem vivi e onde vivi. O lugar também faz parte de nós. Me reconheço entre tijolos e sorrio: isso também sou eu. Isso também é nós.</i>
            </p>
            <p>
                <i>Desconforto? Se faz quase inexistente quando compartilhamos histórias e criamos memórias com quem também é humano.</i>
            </p>
            <p>
                <i>Naquele espaço, o silêncio, o choro, o riso e o grito se fizeram tão presentes quanto nossos corpos. Mas, pra além de qualquer coisa, nos fizeram existir e estar, assim como deve ser.</i>
            </p>
            <div>
                <iframe
                width="100%"
            ...
            <p>
                <i>Uma memória minha sobre Gleice: A primeira leitura de texto desenvolvido a partir de entrevista com seu pai, que veio da região Nordeste do Brasil.</i>
            </p>
        </section>
        <section>
            <h4>
        ...
        <section>
            ...
            <figure>
                ...
                className={styles.image}
                />
                <figcaption>Digitalização de escrita em papel, 2022 | Fonte: acervo do autor</figcaption>
            </figure>
            <p>
                11/12/2022
            </p>
            ...
            <blockquote>
                ...
                <p>Não quero parar. Não desligue essa fonte.</p>
            </blockquote>
            <blockquote>
                <p>
                    <b>Uma memória minha de Susana</b>
                </p>
                <p>
                    <b>Memória Sonora e Visual do seguinte exercício:</b>
                </p>
                <p>
                    <b>Improviso a partir da tela de Edgar Degas, intitulada Antes da Performance</b>
                </p>
            </blockquote>
            <figure>
                <Image
            ...
            <p>
                <b>No dia, o grupo tinha que criar um improviso coletivo, tendo menos de 3 minutos para se preparar. Para essa apresentação, uma aluna de dança do Centro Cultural da Penha se candidatou a participar como espectadora, somando a mim como plateia dessa cena teatral.</b>
            </p>
            <div>
                <iframe
                width="100%"
        ...
        <section>
            ...
            <p>
                _EM CONSTRUÇÃO_ MEMÓRIAS DE COMO COMECEI A MEDIAR EM CASA RELACIONANDO COM MINHA TIA CLAUDETE
            </p>
            <figure>
                <Image
                ...
                className={styles.image}
                />
                <figcaption>Foto que fiz no jardim da casa da minha tia Claudete</figcaption>
            </figure>
        </section>
        <section>
            <h4>
            ...
            <p>
                <i>As memórias do passado são o que nos fazem ser capazes de avaliar o presente como planejamos para viver o amanhã.
        ...
        <section>
            ...
            <p>
                _EM CONSTRUÇÃO_ ideia de colocar o nome de todas as pessoas participantes e envolvidas no projeto.
            </p>
        </section>
      </main>
